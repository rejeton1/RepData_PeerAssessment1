...
the mean value is `r mean_steps_per_day`, and the median value is `r median_steps_per_day`.
<br/><br/>
...
The interval that contain maximum number of steps is, `r interval_max`.
...
total_NA
```
There are `r total_NA` of missing values.<br/>
...
the mean value of total number of steps per each day is `r New_mean_per_day`  
the median value of it is `r New_median_per_day`, in comparison with the fact that each of those values are `r mean_steps_per_day`, `r median_steps_per_day` in original data.
